...
export declare const createDictionarySubsetError: (id: string) => string;
...
export declare const flattenDictionaryError: (error: Error, locale: string) => string;
export declare const defaultDictionaryUnavailableError = "gt-next Error: Default dictionary is unavailable. Make sure you have provided a dictionary.js, dictionary.json, or [defaultLocale].json file.";
...
export declare const flattenDictionaryWarning: (error: Error, locale: string) => string;
export declare const defaultDictionaryUnavailableWarning = "gt-next: Default dictionary is unavailable. Make sure you have provided a dictionary.js, dictionary.json, or [defaultLocale].json file.";
export declare const dictionaryUnavailableWarning: (locale: string) => string;
export declare const createDictionarySubsetWarning: (id: string) => string;
