...
import { RenderMethod, TranslatedChildren, TranslatedContent, TranslationError, TranslationsObject, TranslationSuccess, TranslationLoading, Children, Metadata, Child, GTProp, GTTranslationError, DictionaryTranslationOptions, InlineTranslationOptions, RuntimeTranslationOptions, CustomLoader, RenderVariable, VariableProps } from './types/types';
import { GTContextType, ClientProviderProps } from './types/providers';
import { defaultLocaleCookieName } from './utils/cookies';
import { Dictionaries, Dictionary, DictionaryContent, DictionaryEntry, DictionaryObject, Entry, FlattenedDictionary } from './types/dictionary';
export { addGTIdentifier, writeChildrenAsObjects, isVariableObject, Dictionary, flattenDictionary, getDictionaryEntry, isValidDictionaryEntry, getVariableProps, DictionaryEntry, GTTranslationError, Metadata, getPluralBranch, getEntryAndMetadata, getVariableName, renderDefaultChildren, renderTranslatedChildren, renderSkeleton, RenderMethod, defaultRenderSettings, Children, Child, GTProp, Entry, TranslatedChildren, TranslatedContent, TranslationsObject, TranslationLoading, TranslationError, TranslationSuccess, GTContextType, ClientProviderProps, DictionaryTranslationOptions, InlineTranslationOptions, RuntimeTranslationOptions, DictionaryContent, DictionaryObject, CustomLoader, RenderVariable, VariableProps, defaultLocaleCookieName, Dictionaries, FlattenedDictionary, };
