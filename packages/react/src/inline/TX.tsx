...
/**
 * Translation component that handles rendering translated dynamic content, including plural forms.
...
function T({
  ...
  if (isEmptyReactFragment(children) || !children) return <React.Fragment />;
